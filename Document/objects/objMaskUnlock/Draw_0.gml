...
if (fade == 1)
{
	...
	// else {fade=0 if restart=1 {sxeasy_stop(1) sxeasy_setVolume(0) sxeasy_play(working_directory+"\HorseSteppin.mp3"); room=rmMenu} else {if next=1 {if newsong=1 {sxeasy_stop(1) sxeasy_setVolume(0) sxeasy_play(song);} room=nextroom} else {scrResetActiveSurfaces() game_load(working_directory+"\tempsave.sav")}}}
}
