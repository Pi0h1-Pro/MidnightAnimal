...
surface_set_target(global.surf1);
draw_clear_alpha(c_black, 0);
color1 = merge_color(c_yellow, c_fuchsia, 0.5 + lengthdir_x(0.5, dir));
...
if (current <= 15)
{
	...
	repeat (12)
	{
		draw_set_color(merge_color(merge_color(c_teal, c_fuchsia, 0.5 + lengthdir_x(0.5, dir)), merge_color(c_aqua, c_yellow, 0.5 + lengthdir_x(0.5, dir * 1.72)), i * (1 / 12)));
		if (frac(i * 0.5) > 0)
