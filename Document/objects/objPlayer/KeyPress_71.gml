...
if (global.done == 1 || global.active == 0)
	exit;
...
if (thrown == 0)
{
	switch (global.character)
	{
		...
		case 1: // THOMAS 
			...
			break;
		case 2: // PIERRETTE 
			if (sprite_index == pierretteWalkSMG || sprite_index == pierretteWalkShotgun)
				scrPlayerThrow(pierretteThrow, sndThrow, objFlashbang, 10);
			else
				scrPlayerThrow(pierretteThrowShield, sndThrow, objFlashbang, 10);
