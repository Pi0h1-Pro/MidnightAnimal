...
if (scrIsDisarming())
	exit; // or scrIsReloading(sprite_index)
...
{
	if (reload == 0 && !(sprite_index == simoneWalkShield || sprite_index == simoneExecuteShield1 || sprite_index == simoneExecuteShield2))
	{
	...
	{
		if (ammo > 0)
			sprite_index = choose(simoneExecuteShield1, simoneExecuteShield2);
		else
