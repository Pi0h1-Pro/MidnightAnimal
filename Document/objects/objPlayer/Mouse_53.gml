...
if (teleport == true)
{
	...
	if (scrPlaceFree(global.mousex, global.mousey) && !place_meeting(global.mousex, global.mousey, objEnemy))
	{
...
if (scrIsDisarming() || reload > 0 || teleport == true || global.done == 1)
	exit;
...
// PIERRETTE: Ready up.
if (sprite_index == pierretteWalkUnarmed && ready == 0)
{
