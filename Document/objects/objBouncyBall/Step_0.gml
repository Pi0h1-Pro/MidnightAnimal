...
if (place_meeting(x + hspeed, y, objWall)
	|| place_meeting(x + hspeed, y, objEnemy)
	|| place_meeting(x + hspeed, y, objDoorV)
	|| place_meeting(x + hspeed, y, objWindow))
{
...
if (place_meeting(x, y + vspeed, objWall)
	|| place_meeting(x, y + vspeed, objEnemy)
	|| place_meeting(x, y + vspeed, objDoorV)
	|| place_meeting(x, y + vspeed, objWindow))
{
	direction = -direction;
	bounce += 1;
	sound_ps(sndBounce);
