function thomasMelee() {
	if (scrIsSwinging(objPlayer.sprite_index) && global.character == 1)
	{
		if (objPlayer.sprite_index == thomasStrikeR1
			|| objPlayer.sprite_index == thomasStrikeR2
			|| objPlayer.sprite_index == thomasStrikeR3
			|| objPlayer.sprite_index == thomasStrikeR4)
			objPlayer.melee_damage = 33 + round(random(50));
		else if (objPlayer.sprite_index == thomasStrikeL1
			|| objPlayer.sprite_index == thomasStrikeL2
			|| objPlayer.sprite_index == thomasStrikeL3
			|| objPlayer.sprite_index == thomasStrikeL4)
