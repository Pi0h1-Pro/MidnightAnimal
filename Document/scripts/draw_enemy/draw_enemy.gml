/// @description  draw_enemy(legs, hp colour)
/// @param legs
/// @param  hp colour
function draw_enemy(argument0, argument1) {
	if (path_index >= 0 && (alert >= 3 || alert == 0))
		angle = direction;
	if (speed > 0 && alert == 0)
		angle = direction;
	...
	// Draw legs.
	if (speed > 0 || path_index >= 0 || !scrIsSearching(sprite_index))
		draw_sprite_ext(argument0, image_index * 2, x, y, image_xscale, image_yscale, direction, image_blend, 1);
