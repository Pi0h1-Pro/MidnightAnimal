function scrPlayerAttackUnarmed() {
		...
		|| sprite_index == sprPAttackDrill)
	{
		...
		with (objEnemy)
		{
			...
			(place_meeting(x - global.spacex, y - global.spacey, objPlayer) && valid == 1)
			{
				...
				if (sprite_index == sprPAttackDrill)
					...
					objPlayer.melee_damage = 10 + round(random(10));
