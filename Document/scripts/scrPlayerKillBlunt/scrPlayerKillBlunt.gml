function scrPlayerKillBlunt() {
	if (objPlayer.sprite_index == sprPAttackClub
		...
		|| objPlayer.sprite_index == sprPAttackPool
		|| objPlayer.sprite_index == sprPAttackChain
		|| objPlayer.sprite_index == sprPAttackBag
		|| objPlayer.sprite_index == sprPAttackSkateboard
		|| objPlayer.sprite_index == sprPAttackBust
		|| objPlayer.sprite_index == sprPAttackArm
		|| objPlayer.sprite_index == sprPAttackBrick
		|| objPlayer.sprite_index == sprPAttackGuitar
		|| objPlayer.sprite_index == sprPAttackHammer
		|| objPlayer.sprite_index == sprPAttackWrench
		|| objPlayer.sprite_index == sprPAttackBottle
		|| objPlayer.sprite_index == sprPAttackBong)
	{
		if (hit == 0)
		{
			if (objPlayer.sprite_index == sprPAttackClub
			...
			// Breakables.
			if (objPlayer.sprite_index == sprPAttackBottle || objPlayer.sprite_index == sprPAttackBong)
			{
				sound_ps(sndGlass1);
