...
function scr_createPathTo(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
	...
	do
	{
		...
		for (a = 0; a <= ds_list_size(cellTrimList) / 2 - 1; a++)
		{
			...
			if (ds_grid_get(grid_cellChecked, (x0 - argument4 * .5) / argument4, (y0 - (argument4 + argument4 * .5)) / argument4) == 1)
			{
				// N
				e += 3;
			}
			if (ds_grid_get(grid_cellChecked, (x0 + argument4 * .5) / argument4, (y0 - argument4 * .5) / argument4) == 1)
			{
				// E
				e += 7;
			}
			...
			if (ds_grid_get(grid_cellChecked, (x0 - (argument4 + argument4 * .5)) / argument4, (y0 - argument4 * .5) / argument4) == 1)
			{
				// W
				e += 13;
			}
			switch (e)
			{
				...
				case 24: // S/W 
					...
					break;
				case 16: // N/W 
					if (ds_grid_get(grid_cellChecked, (x0 - (argument4 + argument4 * .5)) / argument4, (y0 - (argument4 + argument4 * .5)) / argument4) == 1)
					{
						// NW
						f = true;
					}
