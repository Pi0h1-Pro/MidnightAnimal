/// @description  path_random(x1,y1,x2,y2,path,segment length,beam_tolerance,curl)
/// @param x1
/// @param y1
/// @param x2
/// @param y2
...
/// @param beam_tolerance
/// @param curl
function path_random(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
