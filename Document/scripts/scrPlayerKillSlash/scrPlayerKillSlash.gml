function scrPlayerKillSlash() {
	// Slashed.
	if (objPlayer.sprite_index == sprPAttackChainsaw
		|| objPlayer.sprite_index == sprPAttackCircularSaw
		...
		|| objPlayer.sprite_index == sprPAttackLeviathan
		|| objPlayer.sprite_index == sprPAttackHalberdH
		|| objPlayer.sprite_index == sprPAttackHalberdV)
	{
