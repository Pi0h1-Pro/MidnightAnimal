/// @description  register_enemy_hit(projectile)
/// @param projectile
function register_enemy_hit(argument0) {
	...
	if (other.sprite_index == sprBullet || other.sprite_index == sprBulletRicochet)
	{
		scrBloodShot(x, y, 1);
	...
	if (hp <= 0)
	{
		if (other.sprite_index == sprBullet || other.sprite_index == sprBulletRicochet || other.sprite_index == sprShotgunPellet)
			scrEnemyDieShot(argument0);
		if (other.sprite_index == sprShockRound)
			scrEnemyDieStunned(argument0);
	}
