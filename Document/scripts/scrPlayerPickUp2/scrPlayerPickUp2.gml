function scrPlayerPickUp2() {
	...
	if (reload > 0)
		reload = 0;
	if (objPlayer.sprite_index == sprPWalkBag || sprite_index == sprPWalkBossgun || objPlayer.sprite_index == sprPLeaveBag || sprite_index == sprPTakePhone)
		exit;
	...
	else
	{
		...
		if (global.maskindex == 24)
			my_id.speed = 16 + random(2);
		else
			my_id.speed = 9 + random(2);
		my_id.ammo = lastammo;
