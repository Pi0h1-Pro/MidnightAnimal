...
function draw_lens_flare(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
	...
	{
		center_x = __view_get( e__VW.XView, 0 ) / 2;
		center_y = __view_get( e__VW.YView, 0 ) / 2;
	}
	...
	// Draw ring.
	draw_sprite_ext(sprLFRing, 0, center_x, center_y, RingSize * point_distance(center_x, center_y, xx, yy) / (__view_get( e__VW.WView, 0 ) / 2), RingSize * point_distance(center_x, center_y, xx, yy) / (__view_get( e__VW.WView, 0 ) / 2), LensDir, -1, alpha);
