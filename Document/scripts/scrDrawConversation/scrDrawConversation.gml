function scrDrawConversation() {
	if (!sprite_exists(lastsprite))
		lastsprite = sprite;
	if (instance_exists(objPhoneConversation) && lastsprite == sprite)
	{
		conversationwait = 1;
		...
		if (blackx == 45)
		{
			...
			draw_text(27, __view_get( e__VW.HView, 0 ) - 57, string_hash_to_newline(string_upper(objPhoneConversation.line1[objPhoneConversation.current])));
			draw_text(27, __view_get( e__VW.HView, 0 ) - 39, string_hash_to_newline(string_upper(objPhoneConversation.line2[objPhoneConversation.current])));
			draw_set_color(textcolor2);
			draw_text(25.5 - lengthdir_x(0.5, global.dir * 4), __view_get( e__VW.HView, 0 ) - 58.5 - lengthdir_x(0.5, global.dir * 4), string_hash_to_newline(string_upper(objPhoneConversation.line1[objPhoneConversation.current])));
			draw_text(25.5 - lengthdir_x(0.5, global.dir * 4), __view_get( e__VW.HView, 0 ) - 40.5 - lengthdir_x(0.5, global.dir * 4), string_hash_to_newline(string_upper(objPhoneConversation.line2[objPhoneConversation.current])));
		}
	}
	else
	{
