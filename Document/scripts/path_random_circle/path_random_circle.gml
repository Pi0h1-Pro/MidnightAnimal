/// @description  path_random_circle(path,x,y,r1,r2,angle,segments)
/// @param path
/// @param x
/// @param y
/// @param r1
...
/// @param angle
/// @param segments
function path_random_circle(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
