function scrHearExplosion(argument0, argument1) {
	...
	with (objEnemy)
	{
		...
		{
			if (ds_list_find_value(global.distlist, 0) == dist && dist < 300)
			{
				if (alert == 0)
					scrChasePlayer(path, argument0, argument1);
			}
			if (ds_list_find_value(global.distlist, 1) == dist && dist < 300)
			{
				if (alert == 0)
					scrChasePlayer(path, argument0, argument1);
			}
			if (ds_list_find_value(global.distlist, 2) == dist && dist < 300)
			{
				if (alert == 0)
					scrChasePlayer(path, argument0, argument1);
			}
