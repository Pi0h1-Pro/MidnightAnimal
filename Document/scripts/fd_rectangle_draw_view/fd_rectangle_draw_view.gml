/// @description fd_rectangle_draw_view(instance id, color, alpha, use interpolation)
/// @param instance id
/// @param  color
/// @param  alpha
/// @param  use interpolation
function fd_rectangle_draw_view(argument0, argument1, argument2, argument3) {
