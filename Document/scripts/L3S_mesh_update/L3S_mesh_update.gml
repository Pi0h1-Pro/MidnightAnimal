					...
					case 0:
						{
							...
							d3d_model_vertex(other.LS_model, LS_Lx1, LS_Ly1, 0);
							d3d_model_vertex(other.LS_model, bbox_left, bbox_top, 0);
							d3d_model_vertex(other.LS_model, LS_Lx1, LS_Ly2, 0);
							d3d_model_vertex(other.LS_model, bbox_right, bbox_top, 0);
							d3d_model_vertex(other.LS_model, LS_Lx2, LS_Ly2, 0);
							d3d_model_vertex(other.LS_model, bbox_right, bbox_bottom, 0);
							d3d_model_vertex(other.LS_model, LS_Lx2, LS_Ly1, 0);
							d3d_model_vertex(other.LS_model, bbox_left, bbox_bottom, 0);
							d3d_model_vertex(other.LS_model, LS_Lx1, LS_Ly1, 0);
					...
					case 1:
						{
							...
							d3d_model_vertex(other.LS_model, LS_Lx2, LS_Ly2, 0);
							d3d_model_primitive_end(other.LS_model);
							d3d_model_cylinder(other.LS_model, LS_x3 - LS_rd, LS_y3 - LS_rd, 0, LS_x3 + LS_rd, LS_y3 + LS_rd, 1, 0, 0, 1, 24);
							break;
						}
					case 2:
						{
							...
							for (i = 0; i < ds_list_size(LS_shadow_poly); i += 3)
							{
								...
								d3d_model_vertex(other.LS_model, LS_x1, LS_y1, 0);
								d3d_model_vertex(other.LS_model, LS_x1 + (LS_x1 - other.x) * LS_zmod, LS_y1 + (LS_y1 - other.y) * LS_zmod, 0);
							}
							d3d_model_primitive_end(other.LS_model);
							break;
						}
