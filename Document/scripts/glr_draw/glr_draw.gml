...
function glr_draw() {
	...
	*/
	...
	if(view_enabled){
	    ...
	    v_x1 = v_x0+__view_get( e__VW.WView, 0 )+10,
	    v_y1 = v_y0+__view_get( e__VW.HView, 0 )+10;
	}else{
	    var v_x0 = 0,
	    v_y0 = 0,
	    v_x1 = room_width,
	    ...
	    shader_set(glr_shader_blur_ver);
	     ...
	     if(surface_exists(global.GLR_MAIN_SURFACE)){   
	        ...
	        if(os_browser != browser_not_a_browser)
	        {
	            ...
	            {
	                offsetX = floor(__view_get( e__VW.XView, 0 )) - __view_get( e__VW.XView, 0 ); 
	                sizeX = -offsetX; 
	            }
	            else
	                sizeX = __view_get( e__VW.XView, 0 ) - floor(__view_get( e__VW.XView, 0 ));
                
                
	            if(__view_get( e__VW.YView, 0 ) < 0)
	            {
	                offsetY = floor(__view_get( e__VW.YView, 0 )) - __view_get( e__VW.YView, 0 ); 
	                sizeY = -offsetY; 
	            }
	            else
	                sizeY = __view_get( e__VW.YView, 0 ) - floor(__view_get( e__VW.YView, 0 )); 
