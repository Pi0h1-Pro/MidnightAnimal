function scrCreateBonusList() {
	...
	repeat (floor(random(4)))
		ds_list_add(global.bonuslist, string(ceil(random(12))) + "X COMBO");
	repeat (floor(random(4)))
		ds_list_add(global.bonuslist, "EXPOSURE");
	repeat (floor(random(4)))
		ds_list_add(global.bonuslist, "EXECUTION");
	repeat (floor(random(4)))
		ds_list_add(global.bonuslist, "PRESSURE PICKUP");
	repeat (floor(random(2)))
		ds_list_add(global.bonuslist, "DOUBLE KILL");
	repeat (floor(random(4)))
	...
	repeat (floor(random(4)))
		ds_list_add(global.bonuslist, "MULTI KILL");
