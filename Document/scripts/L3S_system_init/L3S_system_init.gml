function L3S_system_init(argument0, argument1, argument2, argument3, argument4) {
	...
	global.LS_light = surface_create(__view_get( e__VW.WView, 0 ) + 100, __view_get( e__VW.HView, 0 ) + 100);
	global.LS_shadow = surface_create(__view_get( e__VW.WView, 0 ) + 100, __view_get( e__VW.HView, 0 ) + 100);
	global.LS_lightmap = surface_create(__view_get( e__VW.WView, 0 ) + 100, __view_get( e__VW.HView, 0 ) + 100);
