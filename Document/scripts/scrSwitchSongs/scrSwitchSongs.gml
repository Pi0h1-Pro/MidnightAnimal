/// @description  scrSwitchSongs(NewTrack,FadeTimeSeconds)
/// @param NewTrack
/// @param FadeTimeSeconds
function scrSwitchSongs(argument0, argument1) {
	...
	if (audio_get_name(global.CurrentSong) == NewTrackName)
		exit;
	...
	if (audio_exists(global.CurrentSong))
