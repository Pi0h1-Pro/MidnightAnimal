function L3S_define_bloom(argument0, argument1, argument2, argument3, argument4, argument5) {
	...
	if (global.LS_bloom)
	{
		...
		global.LS_bloom_width = __view_get( e__VW.WView, 0 ) * argument1;
		global.LS_bloom_height = __view_get( e__VW.HView, 0 ) * argument1;
