function scrGoGetWeaponGang() {
	...
	if (weaponfind == 0)
	{
		...
		else
		{
			checkreload = 10;
			global.check = 0;
			while (i < instance_number(objWeapon) && global.check == 0)
			{
		...
		if (weaponfind == 0 && instance_exists(objPlayer))
		{
	...
	else
	{
		...
		else
		{
			...
			if (place_meeting(x, y, target))
			{
				...
				{
					my_id = instance_create(x, y, objGang);
					my_id.sprite_index = sprEGangWalkShotgun;
				}
				...
				{
					my_id = instance_create(x, y, objGangMelee);
					my_id.sprite_index = sprEGangWalkPipe;
				}
				if (target.image_index == 4)
				{
					my_id = instance_create(x, y, objGangMelee);
					my_id.sprite_index = sprEGangWalkBat;
				}
				...
				if (target.image_index == 11)
					exit;
				if (target.image_index == 12)
					exit;
				if (target.image_index == 13)
					exit;
				if (target.image_index == 14)
					exit;
				if (target.image_index == 15)
					exit;
				if (target.image_index == 16)
					exit;
				if (target.image_index == 17)
					exit;
				if (target.image_index == 18)
					exit;
				if (target.image_index == 19)
					exit;
				if (target.image_index == 20)
					exit;
				if (target.image_index == 21)
					exit;
				if (target.image_index == 22)
					exit;
				if (target.image_index == 23)
					exit;
				if (target.image_index == 24)
					exit;
				if (target.image_index == 25)
					exit;
				...
				{
					my_id = instance_create(x, y, objGang);
					my_id.sprite_index = sprEGangWalk9mm;
				}
				if (target.image_index == 28)
					exit;
				if (target.image_index == 29)
					exit;
				if (target.image_index == 30)
					exit;
				if (target.image_index == 31)
					exit;
				if (target.image_index == 32)
					exit;
				if (target.image_index == 33)
					exit;
				if (target.image_index == 34)
				{
					my_id = instance_create(x, y, objGangMelee);
					my_id.sprite_index = sprEGangWalkChain;
				}
				if (target.image_index == 35)
					exit;
				if (target.image_index == 36)
					exit;
				if (target.image_index == 37)
					exit;
				if (target.image_index == 38)
					exit;
				if (target.image_index == 39)
					exit;
				if (target.image_index == 40)
					exit;
				if (target.image_index == 41)
					exit;
				if (target.image_index == 42)
					exit;
				if (target.image_index == 43)
					exit;
				if (target.image_index == 44)
					exit;
				if (target.image_index == 45)
					exit;
				if (target.image_index > 7)
					exit;
				if (instance_exists(target))
