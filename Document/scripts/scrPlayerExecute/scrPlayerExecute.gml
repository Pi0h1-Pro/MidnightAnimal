function scrPlayerExecute() {
	...
	if (scrIsWalking(sprite_index))
	{
		with (objEnemyGiveUp)
		{
			...
			{
				if (place_meeting(x, y, objPlayer) && objPlayer.shield == 0)
				{
					with (objPlayer)
					{
		...
		with (objKnockedOut)
		{
			if (place_meeting(x, y, objPlayer) && global.state == 0 && global.character == 0)
			{
				global.state = 1;
				px = objPlayer.x;
				py = objPlayer.y;
				...
				{
					// Chainsaw kill lean.
					if (scrCurrentWeaponExt(objPlayer.sprite_index) == 31)
						kill = instance_create(x, y, objPKillChainsawLean);
					else
					{
				...
				else
				{
					...
					if (kill.object_index == objPBluntKill)
					{
						...
						{
							case 4:
								kill.sprite_index = sprPBatKill;
								break;
							case 17:
								kill.sprite_index = sprPKillCrowbar;
								break;
							case 44:
								kill.sprite_index = sprPKillGuitar;
								break;
							case 39:
								kill.sprite_index = sprPKillArm;
								break;
							case 40:
								kill.sprite_index = sprPKillBust;
								break;
							case 75:
								kill.sprite_index = sprPPipeKill;
								break;
							case 24:
								kill.sprite_index = sprPKillPot;
								break;
							case 22:
								kill.sprite_index = sprPKillPan;
								break;
						}
					}
				}
