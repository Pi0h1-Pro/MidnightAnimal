function scrMotionBlur(argument0, argument1, argument2, argument3) {
	...
	if (len > 0 || rot > 0)
	{
		...
		draw_sprite_ext(sprite_index, image_index, xp, yp, image_xscale, image_yscale, image_angle, image_blend, 0.5);
