function scrPlayerKillCut() {
	if (objPlayer.sprite_index == sprPAttackKnife
		...
		|| objPlayer.sprite_index == sprPAttackKatanaThrust
		|| objPlayer.sprite_index == sprPAttackKnifePistol)
	{
		...
		if (hp <= 0)
		{
			...
			if (body.image_index == 6 || body.image_index == 7 || body.image_index == 8 || body.image_index == 9 || body.image_index == 13 || body.image_index == 16)
				scrMeleeBlood(x, y);
