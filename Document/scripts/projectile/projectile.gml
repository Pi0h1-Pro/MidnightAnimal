/// @description  projectile(lengthdir, projectile, speed, spread, critRate, damage, sprite)
/// @param lengthdir
/// @param  projectile
/// @param  speed
/// @param  spread
...
/// @param  damage
/// @param  sprite
function projectile(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
