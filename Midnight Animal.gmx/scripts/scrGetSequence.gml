...
if argument0=rmSequence4 {global.parttitle[0]="Act I" 
global.parttitle[1]="The Good Soldier" global.nextlevel=rmDream2 
global.sequence=rmPart return rmBar1}
...
if argument0=rmSequence8 {global.parttitle[0]="Act II" 
global.parttitle[1]="A Death in the Family" global.nextlevel=rmDream3 
global.sequence=rmPart return rmBar2}
...
if argument0=rmSequence12 {global.parttitle[0]="Act III" 
global.parttitle[1]="Phantom Pains" global.nextlevel=rmSequence12bDownstairs global.sequence=rmPart return rmBar3}
if argument0=rmSequence12bDownstairs {global.sequence=rmSequence13Downstairs song=working_directory+"\WeDontTalkMuchAnymore.mp3" return global.sequence}
if argument0=rmSequence13 {global.sequence=rmSequence14 song=working_directory+"\WeDontTalkMuchAnymore.mp3" return global.sequence}
if argument0=rmSequence14 {global.sequence=rmChapter global.level=rmMansionEntrance 
global.pretitle="Finale" global.title="A New Morning" song="HangEm.mp3" return global.sequence}
