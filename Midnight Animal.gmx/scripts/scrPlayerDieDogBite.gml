...
if object_index=objPlayerBiker my_id.sprite_index=sprNicoleDeadDog else my_id.sprite_index=sprPBackEaten
...
if sprite_index=sprPWalkUnarmed or sprite_index=sprPAttackUnarmed1 or sprite_index=sprPAttackPunch or sprite_index=sprPAttackBash noweapon=1 else noweapon=0
/*
if noweapon=0 {
