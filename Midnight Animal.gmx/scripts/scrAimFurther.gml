...
if room != rmPhoneHomEntrance and aimfar {
    ...
    if view_xview[0] > room_width - view_wview[0] - 12 view_xview[0] = room_width - view_wview[0] - 12
    if view_yview[0] > room_height - view_hview[0] - 12 view_yview[0] = room_height - view_hview[0] - 12
    if view_xview[0] < 12 view_xview[0] = 12
    if view_yview[0] < 12 view_yview[0] = 12
