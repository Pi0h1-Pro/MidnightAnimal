 if global.controllertype = 0 or object_index = objPlayerMouse or object_index = objPlayerHospital or object_index = objPlayerBikerHouse {
     if //checkbutton(0, getid(9)) 
     trigger_pressed(1)
     or instance_exists(global.enemy) {
