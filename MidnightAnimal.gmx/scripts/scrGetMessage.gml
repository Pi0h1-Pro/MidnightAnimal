...
scrDialogueDream(argument0)
scrDialogueAmy(argument0)
scrDialogueApartment(argument0)
...
if argument0=2 {
my_id.sprite=sprNicoleNoScar
my_id.index=0
with objEffector {image_xscale=1.5 image_yscale=1.5 sprite=sprNicoleNoScar}
