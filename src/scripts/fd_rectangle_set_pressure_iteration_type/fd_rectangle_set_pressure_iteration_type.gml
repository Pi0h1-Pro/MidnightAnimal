/// @description  fd_rectangle_set_pressure_iteration_type(instance id, iteration type)
/// @param instance id
/// @param  iteration type
function fd_rectangle_set_pressure_iteration_type(argument0, argument1) {
