/// @description  get_reflected_vector(cx, cy, incidence_direction, collision_object)
/// @param cx
/// @param  cy
/// @param  incidence_direction
...
function get_reflected_vector(argument0, argument1, argument2, argument3) {
