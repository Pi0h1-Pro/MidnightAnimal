/// @description  fd_rectangle_set_velocity_maccormack_weight(instance id, MacCormack weight)
/// @param instance id
/// @param  MacCormack weight
function fd_rectangle_set_velocity_maccormack_weight(argument0, argument1) {
