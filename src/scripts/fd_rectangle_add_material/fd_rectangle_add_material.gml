/// @description  fd_rectangle_add_material(instance id, sprite index, image index, x, y, xscale, yscale, color, alpha)
/// @param instance id
/// @param  sprite index
/// @param  image index
/// @param  x
...
/// @param  color
/// @param  alpha
function fd_rectangle_add_material(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
