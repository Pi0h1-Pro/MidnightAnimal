/// @description  draw_sprite_hud(sprite, subimg, x, y, xscale, yscale, angle)
/// @param sprite
/// @param  subimg
/// @param  x
/// @param  y
...
/// @param  yscale
/// @param  angle
function draw_sprite_hud(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
