...
for (i = 0; i < min(ds_list_size(list), length); i++) {
    ...
    positioned = x > (__view_get( e__VW.WView, 0 ) / 2  + 72 - 2) and x < (__view_get( e__VW.WView, 0 ) / 2  + 72 + 2) and y > ((__view_get( e__VW.HView, 0 ) / 2 - 76 - padding * 2) - 2) and y < ((__view_get( e__VW.HView, 0 ) / 2 - 76 - padding * 2) + 2)
    ...
    if x < __view_get( e__VW.WView, 0 ) / 2  + 72 x += ((__view_get( e__VW.WView, 0 ) / 2  + 72) - x) / 2
    if x > __view_get( e__VW.WView, 0 ) / 2  + 72 x -= (x - (__view_get( e__VW.WView, 0 ) / 2  + 72)) / 2
    
    if y < (__view_get( e__VW.HView, 0 ) / 2 - 76 - padding * 2) y += ((__view_get( e__VW.HView, 0 ) / 2 - 76 - padding * 2) - y) / 2
    if y > (__view_get( e__VW.HView, 0 ) / 2 - 76 - padding * 2) y -= (y - (__view_get( e__VW.HView, 0 ) / 2 - 76 - padding * 2)) / 2
