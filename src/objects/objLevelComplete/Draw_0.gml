...
if state = 0 {
    ...
    if cut = 0 {
        if blot > 0 blot -= 80
        if character > 0 character -= 80
    } else {
        if blot < 1280 blot += 80
        if character < 640 character += 80
    }
}
