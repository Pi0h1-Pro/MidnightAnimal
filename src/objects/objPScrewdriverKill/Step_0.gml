if image_index < 15 image_index += 0.4
else {
...
if image_index >= 5 and bled = 0 {
    ...
    global.shake = 6
    repeat(2 + random(3)) instance_create(x + lengthdir_x(15, image_angle) - 1 + random(2), y + lengthdir_y(15, image_angle) - 1 + random(2), objBloodSquirt)
}
