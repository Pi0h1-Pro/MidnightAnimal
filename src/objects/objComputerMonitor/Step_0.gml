if scrMovingPlayerExists() and(sprite_index = sprComputer or sprite_index = sprComputerBreak) {
...
if sprite_index = sprComputerBreak or sprite_index = sprComputerMonitorBroken {
    if life > 0 {
        life -= 1
        if round(random(3)) = 2 {
        ...
        image_speed = 0
        if sprite_index = sprComputerBreak image_index = 0
    }
}
