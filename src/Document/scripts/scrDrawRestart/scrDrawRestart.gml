function scrDrawRestart() {
	...
	draw_rectangle(0, __view_get( e__VW.HView, 0 ), x2, __view_get( e__VW.HView, 0 )-32, 0)
	...
	// Draw quotes.
	draw_text_transformed(__view_get( e__VW.WView, 0 ) - 24, __view_get( e__VW.HView, 0 ) / 2  - 5, string_hash_to_newline(quote[text]), 0.15, 0.15, 0)

	// Draw restart.
	draw_text_transformed(__view_get( e__VW.WView, 0 ) - 24, __view_get( e__VW.HView, 0 ) / 2 + 24, string_hash_to_newline("Press " + global.restartkey + " " + restart[i]), 0.1, 0.1, 0)
