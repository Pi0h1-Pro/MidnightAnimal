/// @description  draw_texture(texture, x, y, xx, yy, xtex, ytex, colour)
/// @param texture
/// @param  x
/// @param  y
/// @param  xx
...
/// @param  ytex
/// @param  colour
function draw_texture(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
