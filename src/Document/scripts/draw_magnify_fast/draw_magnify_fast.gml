/// @description draw_magnify_fast(x,y,radius,# polygons,texture,texture pixelwidth,texture pixelheight,pixels stretch,degrees twist)
/// @param x
/// @param y
/// @param radius
/// @param # polygons
...
/// @param degrees twist
function draw_magnify_fast(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
