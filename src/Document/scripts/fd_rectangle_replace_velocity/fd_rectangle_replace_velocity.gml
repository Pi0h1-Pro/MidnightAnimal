/// @description  fd_rectangle_replace_velocity(instance id, sprite index, image index, x, y, xscale, yscale, x velocity, y velocity)
/// @param instance id
/// @param  sprite index
/// @param  image index
/// @param  x
...
/// @param  x velocity
/// @param  y velocity
function fd_rectangle_replace_velocity(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
