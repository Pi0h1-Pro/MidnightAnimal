/// @description  fd_rectangle_set_material_dissipation_type(instance id, dissipation type)
/// @param instance id
/// @param  dissipation type
function fd_rectangle_set_material_dissipation_type(argument0, argument1) {
