...
if on > 0 and index < 17 {
    if index >= 2 and index <= 17 draw_sprite_ext(sprite_index, index - 2, x, y, image_xscale, image_yscale, image_angle, merge_color(c_orange, c_maroon, amount), 1)
    if index >= 1 and index <= 16 draw_sprite_ext(sprite_index, index - 1, x, y, image_xscale, image_yscale, image_angle, merge_color(c_yellow, c_orange, amount), 1)
    if index <= 15 draw_sprite_ext(sprite_index, index, x, y, image_xscale, image_yscale, image_angle, merge_color(c_white, c_yellow, amount), 1)
    index += 0.33
}
