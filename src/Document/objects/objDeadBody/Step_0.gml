...
if scrBodyIsFlying(sprite_index) {
    if speed < 1.5 {
        ...
        if image_index = 3 and pool = 0 and sprite_index = sprEShotgunFly {
            dir = image_angle - image_yscale
            repeat(2) instance_create(x + lengthdir_x(7, dir) - 2 + random(4), y + lengthdir_y(7, dir) - 4 + random(8), objBloodPool)
            bled = 1
            repeat(5) {
