...
if (sprite_index == sprEWalkHK417)
{
	...
	else
	{
		...
		reload = 3;
		if (place_meeting(x + lengthdir_x(8, angle), y + lengthdir_y(8, angle), objSolid) || place_meeting(x + lengthdir_x(8, angle), y + lengthdir_y(8, angle), objWall))
		{
...
if (sprite_index == sprEFatGunWalk || sprite_index == sprEFatGunAttack)
{
	if (reload > 0)
		reload -= 1;
	else
