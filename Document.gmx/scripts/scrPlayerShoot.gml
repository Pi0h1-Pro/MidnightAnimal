...
if (ammo > 0)
{
	...
	if (sprite_index == sprPWalkM16)
	{
		...
		global.shake = 8;
		if (place_meeting(x + lengthdir_x(8, dir), y + lengthdir_y(8, dir), objSolid) || place_meeting(x + lengthdir_x(8, dir), y + lengthdir_y(8, dir), objSolidCaster) || place_meeting(x + lengthdir_x(8, dir), y + lengthdir_y(8, dir), objWall))
		{
	...
	if (sprite_index == sprPWalkDW || sprite_index == sprPTurnDW)
	{
		...
		else
		{
			...
			global.shake = 10;
			mask_index = sprWeaponMask;
			if (place_meeting(x + lengthdir_x(8, armangle1), y + lengthdir_y(8, armangle1), objSolid) || place_meeting(x + lengthdir_x(12, armangle1), y + lengthdir_y(12, armangle1), objDoorV))
			{
				my_id = instance_create(x, y, objSmokeHit);
			...
			{
				ammo -= 1;
				if (place_meeting(x + lengthdir_x(8, armangle2), y + lengthdir_y(8, armangle2), objSolid) || place_meeting(x + lengthdir_x(12, armangle2), y + lengthdir_y(12, armangle2), objDoorV))
				{
					my_id = instance_create(x, y, objSmokeHit);
