...
if (global.sequence == rmSequence12)
	return 12;
if (global.sequence == rmSequence12bDownstairs)
	return 13;
if (global.sequence == rmSequence13)
	return 14;
if (global.sequence == rmSequence14)
	return 15;
if (global.sequence == rmChapter)
	return 16;
...
if (global.sequence == rmMCSequence3)
	return 19;
if (global.sequence == rmMCSequence4)
	return 20;
if (global.sequence == rmPart || global.sequence == rmBikeEnding || global.sequence == rmMenu)
	return 1;
return 1;
