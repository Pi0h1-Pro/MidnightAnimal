...
if (instance_exists(global.enemy))
{
	...
	if (global.mousex == global.enemy.x && global.mousey == global.enemy.y)
	{
		...
		myx = global.mousex;
		myy = global.mousey;
		if (myx > view_xview[0] + view_wview[0] - 4)
			myx = view_xview[0] + view_wview[0] - 4;
		if (myy > view_yview[0] + view_hview[0] - 32)
			myy = view_yview[0] + view_hview[0] - 4;
		if (myx < view_xview[0] + 4)
			myx = view_xview[0] + 4;
		if (myy < view_yview[0] + 4)
			myy = view_yview[0] + 4;
